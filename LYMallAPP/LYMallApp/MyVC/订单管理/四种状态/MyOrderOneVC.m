...
@interface MyOrderOneVC ()<UITableViewDataSource,UITableViewDelegate>
{
...
-(void)getData{
    ...
    [NetWorkConnection postURL:@"api/user.order/lists" param:@{@"dataType":@"payment",@"page":[NSString stringWithFormat:@"%ld",(long)self.page]} success:^(id responseObject, BOOL success) {
