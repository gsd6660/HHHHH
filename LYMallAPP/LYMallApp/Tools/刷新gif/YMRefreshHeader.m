...
static CGFloat navigationIsTransparentHeight = 120;
static CGFloat navigationIsNormalHeight = 60.0f;
//static CGFloat kAnimationVWidth = 146;
static CGFloat kAnimationVHeight = 80;
...
- (void)prepare {
    ...
    LOTAnimationView *animation = [LOTAnimationView animationNamed:@"927-triangle-loading"];
...
- (void)placeSubviews {
    ...
    self.animationV.frame = CGRectMake(0, -10, self.frame.size.width, kAnimationVHeight );
}
